    ...
    <div ref={containerRef} className="relative h-screen overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            A revolutionary deck of premium playing cards featuring stunning artwork, superior
            quality, and innovative design. Support us on Kickstarter.
          </motion.p>
          <motion.div
          ...
          >
            <Button size="lg" className="bg-gray-100 text-gray-900 hover:bg-gray-200 rounded-lg">
              Back This Project
